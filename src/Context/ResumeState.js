...
const ResumeState = (props) => {
    ...
    const initialData = {
        personalData: {
            ...
            name: "Your Name",
            summary: 'Skilled web developer with experience in creating dynamic, user-friendly websites and applications. Proficient in HTML, CSS, JavaScript, and various frameworks. Strong problem-solving abilities and a passion for innovative design.',

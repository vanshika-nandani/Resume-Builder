...
const testimonials = [
...

    {
        ...
        role: 'Frontened Web Developer',
        content:
        'A resume builder is an online tool designed to help users create professional resumes quickly and efficiently. It typically offers templates, formatting options, and guidance on including relevant information. These tools simplify the resume creation process, ensuring consistency and enhancing the overall presentation.'

        ...
        <Box
            ...
            <Container
                ...
                <Stack direction={'row'} spacing={6}>
                    <SocialButton label={'Github'} href={'https://github.com/priyadarshi30'}>
                        <FaGithub />
                    </SocialButton>
                    <SocialButton label={'Linkdin'} href={'www.linkedin.com/in/priyadarshipriyanshu'}>
                        <FaSnapchat />
                    </SocialButton>
                    <SocialButton label={'Instagram'} href={'https://instagram.com/priyadarshi_30'}>
                        <FaInstagram />
                    </SocialButton>
                </Stack>
            </Container>
